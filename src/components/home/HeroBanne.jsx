      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full grid lg:grid-cols-12 gap-12 items-center py-12">
        ...
        <div className="lg:col-span-7 space-y-8 text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-2">
            <a
              href="#contact"
              className="group bg-[#F97316] hover:bg-[#EA580C] text-white px-10 py-4.5 rounded-2xl text-sm font-black uppercase tracking-wider transition-all duration-300 transform hover:-translate-y-1 shadow-xl shadow-[#F97316]/20 flex items-center justify-center gap-3"
            >
              Get a Free Quote
