    ...
    <div className="relative sm:h-screen sm:py-0 py-10 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto sm:mt-[0rem] mt-[3rem]">
        ...
        <div className="mt-12 flex flex-col sm:flex-row gap-5 justify-center items-center">
          <a href="#contact"
            className="group bg-[#F97316] hover:bg-[#EA580C] text-white px-12 py-5 rounded-3xl text-lg
          ...
          <a href="#projects"
            className="border-2 border-white/80 hover:border-white text-white px-10 py-5 rounded-3xl text-lg
